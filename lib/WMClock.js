...
WMClock["prototype"] = {
    ...
    // --- change clock state ---
    "run":          WMClock_run,       // WMClock#run():this
...
function WMClock_on(callback) { // @arg Function - callback(time:Numberer, delta:Number, count:Integer):void
                                // @ret this
...
function WMClock_nth(times,      // @arg Integer - value from 1.
                     callback) { // @arg Function - callback(time:Number, delta:Number, count:Integer):void
                                 // @ret this
